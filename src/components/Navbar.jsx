            ...
            <div className="flex items-center justify-between py-2 mx-auto max-w-7xl sm:px-6 lg:px-10">
               <Link to={"/"}>
                  <div className="inline-flex items-center space-x-2">
                     <div className="flex flex-col justify-between my-7 lg:flex-row">
                        <div className="">
                           <div className="font-bold text-2xl ">
                              Food <span className="text-yellow">Spot</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <ul className="inline-flex space-x-8 ml-52">
                     {menuItems.map((item) => (
                        <li key={item.name}>
                           <Link
                              to={item.href}
                              className="text-md font-semibold text-gray-800 transition-all ease-in-out duration-400 hover:text-yellow">
                              {item.name}
                           </Link>
                        </li>
                     ))}
