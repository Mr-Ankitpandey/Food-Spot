            ...
            <div className="mx-auto max-w-7xl">
               <div className="max-w-2xl mx-auto text-center">
                  ...
                  <h2 className="mt-8 text-2xl font-bold leading-tight text-black sm:text-4xl lg:mt-12 lg:text-5xl">
                     Join <span className="border-b-8 border-white">2K+</span>{" "}
                     other Fooders
                  </h2>
                  <p className="max-w-xl mx-auto mt-6 text-base text-gray-600 md:mt-10 lg:text-xl">
                     From our kitchen to your table, we craft each plate with passion and precision.  Join us at Food{" "}
                     <span className="text-white">Spot</span>  Sign up
                     today!
                  </p>
                  <button>
                     <Link
